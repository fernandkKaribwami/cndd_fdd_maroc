...
export default function MembreFormModal({ open, onClose, onSuccess }: MembreFormModalProps) {
  ...
  useEffect(() => {
    setIsEtudiant(form.statut_socio_pro === "ETUDIANT");
  }, [form.statut_socio_pro]);
          ...
          <motion.div
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-extrabold text-gray-900 text-base">Nouveau membre</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="flex gap-3 pt-1">
                ...
                <motion.button type="submit" disabled={loading}
                  ...
                  style={{ background: "linear-gradient(135deg, #CE1126, #991010)", boxShadow: "0 4px 16px rgba(206,17,38,0.25)" }}>
